...
public class LeftPanel {
    ...
    public LeftPanel() {
        ...
        topLeftImage.setIcon(new ImageIcon(
            new ImageIcon(LeftPanel.class.getResource("/view/img/Hust.png")).getImage().getScaledInstance(80, 100, java.awt.Image.SCALE_SMOOTH)
        ));
        ...
        centerIcon.setIcon(new ImageIcon(
            new ImageIcon(LeftPanel.class.getResource("/view/img/app_icon.png")).getImage().getScaledInstance(iconWidth, iconHeight, java.awt.Image.SCALE_SMOOTH)
        ));
